...
- `assets/roommate-bug.png`：基于照片生成的基础角色素材。
- `assets/roommate-smug.png`：未命中时显示的动漫得意贴图状态。
- `assets/roommate-cry.png`：命中后显示 420 毫秒的动漫大哭贴图状态。
- `assets/achievement-birthday.png`：捕获第 8 只时显示的 8 月 8 日隐藏生日成就。
